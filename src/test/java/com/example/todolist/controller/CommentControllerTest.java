...
public class CommentControllerTest extends TestSetting {
    ...
    void createCommentTest() throws Exception {
        ...
        // when - then
        mvc.perform(post("/todo/{todoId}/comments", todoId)
                        .content(commentInfo)
    ...
    void updateCommentTest() throws Exception {
        ...
        // when - then
        mvc.perform(put("/todo/{todoId}/comments/{commentId}", todoId, commentId)
                        .content(commentInfo)
                        .contentType(new MediaType(MediaType.APPLICATION_JSON, StandardCharsets.UTF_8))
                        .accept(new MediaType(MediaType.APPLICATION_JSON, StandardCharsets.UTF_8))
                        .principal(mockPrincipal)
    ...
    void deleteCommentTest() throws Exception{
        ...
        // when - then
        mvc.perform(delete("/todo/{todoId}/comments/{commentId}", todoId, commentId)
                        .principal(mockPrincipal)
                )
                .andExpect(status().isOk())
